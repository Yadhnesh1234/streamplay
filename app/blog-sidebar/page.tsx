          ...
          <div className="-mx-4 flex flex-wrap">
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text="Live" />
                        <TagButton text="PUBG" />
                        <TagButton text="Start" />
                      </div>
                    </div>
                    <div className="mb-5">
                      <h5 className="mb-3 text-sm font-medium text-body-color sm:text-right">
                        Share this Tornament :
                      </h5>
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-sm bg-white dark:shadow-none">
                ...
                <ul className="px-8 py-6">
                  <li>
                     <h1 className="text-2x" style={{fontWeight:"bold"}}>Date :</h1>
                     <p>12/12/2023</p>
                  </li>
                  <li>
                     <h1 className="text-2x" style={{fontWeight:"bold",marginTop:"12px"}}>Time :</h1>
                     <p>10:30pm</p>
                  </li>
                  <li>
                     <h1 className="text-2x" style={{fontWeight:"bold",marginTop:"12px"}}>Location :</h1>
                     <p>Online</p>
                  </li>
                </ul>
              </div>
